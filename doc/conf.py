# -*- coding: utf-8 -*-
#
# Archivo de configuración para construir la documentación de tNP
# creado por sphinx-quickstart el Jue 29 de Mar 2012 09:24:14.
#
...
project = u'tNP'
copyright = u'2011-2012, Nacho Pacheco'
...
latex_documents = [
  ('index', 'tNP.tex', u'tNP',
   u'Traducciones de Nacho Pacheco', 'manual'),
]
...
man_pages = [
    ('index', 'tNP', u'tNP',
     [u'Traducciones de Nacho Pacheco'], 1)
]
...
texinfo_documents = [
  ('index', 'tNP', u'Manual de tNP',
   u'Traducido por Nacho Pacheco', 'tNP',
   'Traducciones de Nacho Pacheco.',
   'Miscellaneous'),
]
